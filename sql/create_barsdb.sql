...
CREATE TABLE aircraft_config (
    ...
    user_name character(16) NOT NULL,
    user_group character(8) NOT NULL,
    update_time timestamp with time zone
);
...
CREATE TABLE book (
    ...
    tour_code character(20),
    amount_paid numeric(15,5),
    booking_status character(1) NOT NULL,
    scrutiny_flag character(1) NOT NULL,
...
CREATE TABLE book_paymt_pass (
    ...
    book_paymt_amt numeric(15,5) NOT NULL,
...
CREATE TABLE book_ticket (
    ...
    cc_apprv_code character(6),
    cc_apprv_type character varying(70),
    al_agent_no integer,
...
CREATE TABLE cancel_fees (
    ...
    xcl_value numeric(12,2) NOT NULL,
...
CREATE TABLE commission_volum (
    ...
    valid_from_date date NOT NULL,
    comm_range_from numeric(12,2) NOT NULL,
    valid_to_date date NOT NULL,
...
--
-- Name: dcs_action_security_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_action_security_mapping (
    dcs_action_security_mapping_id bigint NOT NULL,
    dcs_object_rcd character varying(20) NOT NULL,
    dcs_action_security_rcd character varying(20) NOT NULL,
    remark character varying(240),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_action_security_mapping OWNER TO postgres;

--
-- Name: dcs_action_security_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_action_security_ref (
    dcs_action_security_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_action_security_ref OWNER TO postgres;

--
-- Name: dcs_aircraft_config_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_aircraft_config_ref (
    dcs_aircraft_config_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_aircraft_config_ref OWNER TO postgres;

--
-- Name: dcs_aircraft_tail_number; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_aircraft_tail_number (
    ...
    update_user character varying(5) NOT NULL,
    update_time character varying(19) NOT NULL
);


ALTER TABLE public.dcs_aircraft_tail_number OWNER TO postgres;

--
-- Name: dcs_airport; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_airport (
    dcs_airport_id bigint NOT NULL,
    airport_code character varying(20),
    airport_name character varying(240),
...
ALTER TABLE public.dcs_airport OWNER TO postgres;

--
-- Name: dcs_amendment_reason_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_amendment_reason_code_ref (
    dcs_amendment_reason_code_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE public.dcs_amendment_reason_code_ref OWNER TO postgres;

--
-- Name: dcs_apis_action; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_apis_action (
    dcs_apis_action_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    invalidated_dcs_gateway_action_id bigint,
    flight_seq_no integer,
    apis_description character varying(50),
    cbp_sent character(1),
    submit_date_time timestamp with time zone,
    cbp_reply character varying(200),
    reply_date_time timestamp with time zone,
    cleared_flag integer DEFAULT 0 NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone,
    update_time timestamp with time zone
);
...
ALTER TABLE public.dcs_apis_action OWNER TO postgres;

--
-- Name: dcs_apis_carrier_contact; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_apis_carrier_contact (
    dcs_apis_carrier_contact_id bigint NOT NULL,
    dcs_carrier_rcd character varying(20) NOT NULL,
    apis_carrier_name character varying(240) NOT NULL,
    carrier_data_center_country_code character varying(240) NOT NULL,
    apis_division_in_airline character varying(240) NOT NULL,
    contact_name character varying(240) NOT NULL,
    contact_number character varying(240) NOT NULL,
    contact_fax character varying(240),
    send_email_to character varying(240),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_apis_carrier_contact OWNER TO postgres;

--
-- Name: dcs_apis_flight; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_apis_flight (
    dcs_apisflight_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    seq_no integer NOT NULL,
    file_name character varying(200),
    message_type character(10),
    cleared integer,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone,
    update_time timestamp with time zone
...
ALTER TABLE public.dcs_apis_flight OWNER TO postgres;

--
-- Name: dcs_apisaction; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_apisaction (
    dcs_apisaction_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    invalidated_dcs_gateway_action_id bigint,
    cbp_sent character(1),
    submit_date_time timestamp with time zone,
...
ALTER TABLE public.dcs_apisaction OWNER TO postgres;

--
-- Name: dcs_aux_document; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_aux_document (
    dcs_passenger_document_id bigint NOT NULL,
    document_first_name character varying(100),
    document_middle_name character varying(100),
    document_last_name character varying(100)
);


ALTER TABLE public.dcs_aux_document OWNER TO postgres;

--
-- Name: dcs_baggage; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_baggage (
    dcs_baggage_id bigint NOT NULL,
    dcs_baggage_rule_id bigint,
    dcs_checkin_id bigint NOT NULL,
    dcs_baggage_code_rcd character varying(20) NOT NULL,
    dcs_weight_type_rcd character varying(20) NOT NULL,
    dcs_baggage_color_rcd character varying(20),
    tag_number integer,
    manual_tag_number character varying(20),
    weight numeric(15,4),
    description character varying(240),
    amount numeric(15,4) NOT NULL,
    tax_amount numeric(15,4) NOT NULL,
    damaged_flag integer DEFAULT 0,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_baggage OWNER TO postgres;

--
-- Name: dcs_baggage_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_baggage_code_ref (
    dcs_baggage_code_rcd character varying(20) NOT NULL,
    xml_code character varying(20),
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_baggage_code_ref OWNER TO postgres;

--
-- Name: dcs_baggage_color_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_baggage_color_ref (
    dcs_baggage_color_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_baggage_color_ref OWNER TO postgres;

--
-- Name: dcs_baggage_rule; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_baggage_rule (
    dcs_baggage_rule_id bigint NOT NULL,
    dcs_baggage_rule_type_rcd character varying(20) NOT NULL,
    dcs_weight_type_rcd character varying(20) NOT NULL,
    dcs_currency_rcd character varying(20) NOT NULL,
    from_dcs_airport_id bigint,
    to_dcs_airport_id bigint,
    dcs_baggage_code_rcd character varying(20) NOT NULL,
    amount numeric(15,4) NOT NULL,
    tax_amount numeric(15,4) NOT NULL,
    allowed_count_from integer,
    allowed_count_to integer,
    ...
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    incremental_weight_amount numeric(15,4),
    bag_tag_label character varying(20),
    flight_type character(1) DEFAULT 'B'::bpchar,
    tax_type integer DEFAULT 0,
    dcs_class_rcd character varying(20)
);


ALTER TABLE public.dcs_baggage_rule OWNER TO postgres;

--
-- Name: dcs_baggage_rule_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_baggage_rule_type_ref (
    dcs_baggage_rule_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_baggage_rule_type_ref OWNER TO postgres;

--
-- Name: dcs_baggage_status; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_baggage_status (
    dcs_baggage_status_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    dcs_baggage_status_rcd character varying(20) NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_baggage_status OWNER TO postgres;

--
-- Name: dcs_baggage_status_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_baggage_status_ref (
    dcs_baggage_status_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_baggage_status_ref OWNER TO postgres;

--
-- Name: dcs_boarding; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_boarding (
    dcs_boarding_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    boarding_card_number integer,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_boarding OWNER TO postgres;

--
-- Name: dcs_boarding_itinerary_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_boarding_itinerary_mapping (
    dcs_boarding_itinerary_mapping_id bigint NOT NULL,
    dcs_boarding_id bigint NOT NULL,
    dcs_itinerary_id bigint NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_boarding_itinerary_mapping OWNER TO postgres;

--
-- Name: dcs_boarding_print; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_boarding_print (
    dcs_boarding_print_id bigint NOT NULL,
    dcs_boarding_id bigint NOT NULL,
    dcs_print_identification_id bigint NOT NULL,
    dcs_boarding_print_reason_rcd character varying(20) NOT NULL,
    remark character varying(240)
);


ALTER TABLE public.dcs_boarding_print OWNER TO postgres;

--
-- Name: dcs_boarding_print_reason_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_boarding_print_reason_ref (
    dcs_boarding_print_reason_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_boarding_print_reason_ref OWNER TO postgres;

--
-- Name: dcs_boarding_status; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_boarding_status (
    dcs_boarding_status_id bigint NOT NULL,
    dcs_boarding_id bigint NOT NULL,
    dcs_boarding_status_rcd character varying(20) NOT NULL,
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_boarding_status OWNER TO postgres;

--
-- Name: dcs_boarding_status_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_boarding_status_ref (
    dcs_boarding_status_rcd character varying(20) NOT NULL,
    description character varying(240),
...
ALTER TABLE public.dcs_boarding_status_ref OWNER TO postgres;

--
-- Name: dcs_boarding_zone; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_boarding_zone (
    dcs_boarding_zone_id bigint NOT NULL,
    dcs_aircraft_config_rcd character varying(20) NOT NULL,
    dcs_carrier_rcd character varying(20) NOT NULL,
    zone_start_row integer,
    zone_end_row integer,
    description character varying(240),
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_boarding_zone OWNER TO postgres;

--
-- Name: dcs_booking; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_booking (
    dcs_booking_id bigint NOT NULL,
    dcs_gateway_action_id bigint NOT NULL,
    invalidated_dcs_gateway_action_id bigint,
    dcs_origin_id integer NOT NULL,
    booking_number integer,
    pax_name_rec character varying(20),
    external_locator character varying(20),
    group_name character varying(240),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_booking OWNER TO postgres;

--
-- Name: dcs_booking_remark; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_booking_remark (
    dcs_booking_remark_id bigint NOT NULL,
    dcs_booking_id bigint NOT NULL,
    sequence_number integer,
    remark_text character varying(240),
    added_from_dcs_flag integer DEFAULT 0,
    original_date_time timestamp with time zone,
    original_created_by_user_code character varying(20),
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_booking_remark OWNER TO postgres;

--
-- Name: dcs_cargo_bin; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_cargo_bin (
    dcs_cargo_bin_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    dcs_cargo_bin_rcd character varying(20) NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_cargo_bin OWNER TO postgres;

--
-- Name: dcs_cargo_bin_field; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_cargo_bin_field (
    dcs_cargo_bin_field_id bigint NOT NULL,
    cargo_count integer,
    dcs_cargo_bin_id bigint NOT NULL,
    dcs_cargo_bin_field_rcd character varying(20) NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_cargo_bin_field OWNER TO postgres;

--
-- Name: dcs_cargo_bin_field_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_cargo_bin_field_ref (
    dcs_cargo_bin_field_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_cargo_bin_field_ref OWNER TO postgres;

--
-- Name: dcs_cargo_bin_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_cargo_bin_mapping (
    dcs_cargo_bin_mapping_id bigint NOT NULL,
    dcs_aircraft_config_rcd character varying(20) NOT NULL,
    dcs_cargo_bin_rcd character varying(20) NOT NULL,
    dcs_carrier_rcd character varying(20) NOT NULL,
    dcs_cargo_bin_field_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_cargo_bin_mapping OWNER TO postgres;

--
-- Name: dcs_cargo_bin_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_cargo_bin_ref (
    dcs_cargo_bin_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_cargo_bin_ref OWNER TO postgres;

--
-- Name: dcs_carrier_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_carrier_ref (
    dcs_carrier_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_carrier_ref OWNER TO postgres;

--
-- Name: dcs_cashier_charge; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_cashier_charge (
    dcs_cashier_charge_id bigint NOT NULL,
    dcs_miscellaneous_charge_id bigint,
    dcs_passenger_request_id bigint,
    dcs_baggage_id bigint,
    dcs_checkin_id bigint NOT NULL,
    dcs_upgrade_id bigint,
    dcs_currency_rule_id bigint NOT NULL,
    dcs_charge_type_rcd character varying(20) NOT NULL,
    amount numeric(15,4) NOT NULL,
    tax_amount numeric(15,4) NOT NULL,
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
...
ALTER TABLE public.dcs_cashier_charge OWNER TO postgres;

--
-- Name: dcs_cashier_charge_waive; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_cashier_charge_waive (
    dcs_cashier_charge_waive_id bigint NOT NULL,
    dcs_waive_reason_rcd character varying(20) NOT NULL,
    dcs_cashier_charge_id bigint NOT NULL,
...
ALTER TABLE public.dcs_cashier_charge_waive OWNER TO postgres;

--
-- Name: dcs_charge_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_charge_type_ref (
    dcs_charge_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_charge_type_ref OWNER TO postgres;

--
-- Name: dcs_checkin; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_checkin (
    dcs_checkin_id bigint NOT NULL,
    dcs_passenger_id bigint NOT NULL,
    dcs_checkin_status_rcd character varying(20) NOT NULL,
    dcs_airport_id bigint NOT NULL,
    dcs_location_rcd character varying(20) NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_checkin OWNER TO postgres;

--
-- Name: dcs_checkin_action; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_checkin_action (
    dcs_checkin_action_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    dcs_checkin_action_type_rcd character varying(20) NOT NULL,
    update_user character varying(5),
    update_time timestamp with time zone,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
...
ALTER TABLE public.dcs_checkin_action OWNER TO postgres;

--
-- Name: dcs_checkin_action_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_checkin_action_type_ref (
    dcs_checkin_action_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_checkin_action_type_ref OWNER TO postgres;

--
-- Name: dcs_checkin_amendment; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_checkin_amendment (
    dcs_checkin_amendment_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    amends_dcs_checkin_id bigint NOT NULL,
    description character varying(240),
    dcs_amendment_reason_code_rcd character varying(20) NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_checkin_amendment OWNER TO postgres;

--
-- Name: dcs_checkin_info_request; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_checkin_info_request (
    dcs_checkin_info_request_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    dcs_passenger_info_requested_by_rcd character varying(20) NOT NULL,
    comment character varying(240),
    action_taken_flag integer DEFAULT 0 NOT NULL,
    extra_document_flag integer,
    action_comment character varying(240),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    create_user character varying(5) NOT NULL
...
ALTER TABLE public.dcs_checkin_info_request OWNER TO postgres;

--
-- Name: dcs_checkin_itinerary_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_checkin_itinerary_mapping (
    dcs_checkin_itinerary_mapping_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    dcs_itinerary_id bigint NOT NULL,
    invalidated_dcs_gateway_action_id bigint,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_checkin_itinerary_mapping OWNER TO postgres;

--
-- Name: dcs_checkin_selectee; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_checkin_selectee (
    dcs_selectee_id bigint NOT NULL,
    dcs_checkin_id bigint,
    dcs_gate_pass_person_id bigint,
    dcs_selectee_clearing_reason_code_rcd character varying(20) NOT NULL,
    dcs_selectee_location_code_rcd character varying(20) NOT NULL,
    dcs_selectee_agent_reason_code_rcd character varying(20),
    comment character varying(240),
    action_taken_flag integer DEFAULT 0 NOT NULL,
    action_comment character varying(240),
    witness character varying(240),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    create_user character varying(5) NOT NULL
...
ALTER TABLE public.dcs_checkin_selectee OWNER TO postgres;

--
-- Name: dcs_checkin_status_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_checkin_status_ref (
    dcs_checkin_status_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    receive_coupon_flag integer DEFAULT 0,
    create_user character varying(5) NOT NULL,
    orderflag integer NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    boarding_order integer DEFAULT 0
);


ALTER TABLE public.dcs_checkin_status_ref OWNER TO postgres;

--
-- Name: dcs_class_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_class_ref (
    dcs_class_rcd character varying(20) NOT NULL,
    dcs_compartment_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_class_ref OWNER TO postgres;

--
-- Name: dcs_clear_list; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_clear_list (
    dcs_clear_list_id bigint NOT NULL,
    sid integer NOT NULL,
    cleared character varying(100),
    lastname character varying(80),
    firstname character varying(80),
    middlename character varying(100),
    type character varying(10),
    date_of_birth character varying(80),
    place_of_birth character varying(80),
    citizenship character varying(240),
    passport_no character varying(240),
    misc_text character varying(1000),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    create_user character varying(5) NOT NULL
...
ALTER TABLE public.dcs_clear_list OWNER TO postgres;

--
-- Name: dcs_company_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_company_ref (
    dcs_company_rcd character varying(20) NOT NULL,
    description character varying(240),
    active_flag integer,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_company_ref OWNER TO postgres;

--
-- Name: dcs_compartment_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_compartment_ref (
    dcs_compartment_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_compartment_ref OWNER TO postgres;

--
-- Name: dcs_country_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_country_code_ref (
    dcs_country_code_rcd character varying(20) NOT NULL,
    iso_code character(10),
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_country_code_ref OWNER TO postgres;

--
-- Name: dcs_coupon; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_coupon (
    dcs_coupon_id bigint NOT NULL,
    dcs_passenger_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    dcs_coupon_reason_code_rcd character varying(20) NOT NULL,
    dcs_coupon_type_rcd character varying(20) NOT NULL,
    dcs_currency_rcd character varying(20) NOT NULL,
    dcs_coupon_invalidated_reason_rcd character varying(20),
    amount numeric(15,4),
...
ALTER TABLE public.dcs_coupon OWNER TO postgres;

--
-- Name: dcs_coupon_configuration; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_coupon_configuration (
    dcs_coupon_configuration_id bigint NOT NULL,
    dcs_checkin_status_rcd character varying(20) NOT NULL,
    dcs_priority_rcd character varying(20) NOT NULL,
    dcs_coupon_type_rcd character varying(20) NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_coupon_configuration OWNER TO postgres;

--
-- Name: dcs_coupon_group; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_coupon_group (
    dcs_coupon_group_id bigint NOT NULL,
    description character varying(240),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE public.dcs_coupon_group OWNER TO postgres;

--
-- Name: dcs_coupon_group_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_coupon_group_mapping (
    dcs_coupon_group_mapping_id bigint NOT NULL,
    dcs_coupon_group_id bigint NOT NULL,
    dcs_coupon_id bigint,
    dcs_passenger_id bigint NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE public.dcs_coupon_group_mapping OWNER TO postgres;

--
-- Name: dcs_coupon_invalidated_reason_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_coupon_invalidated_reason_ref (
    dcs_coupon_invalidated_reason_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_coupon_invalidated_reason_ref OWNER TO postgres;

--
-- Name: dcs_coupon_reason_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_coupon_reason_code_ref (
    dcs_coupon_reason_code_rcd character varying(20) NOT NULL,
    description character varying(240),
    active_flag integer DEFAULT 0,
    orderflag integer NOT NULL,
    need_remarks_flag integer DEFAULT 0,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_coupon_reason_code_ref OWNER TO postgres;

--
-- Name: dcs_coupon_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_coupon_type_ref (
    dcs_coupon_type_rcd character varying(20) NOT NULL,
    description character varying(240),
    active_flag integer DEFAULT 0,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_coupon_type_ref OWNER TO postgres;

--
-- Name: dcs_currency_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_currency_ref (
    dcs_currency_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_currency_ref OWNER TO postgres;

--
-- Name: dcs_currency_rule; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_currency_rule (
    dcs_currency_rule_id bigint NOT NULL,
    dcs_currency_rcd character varying(20) NOT NULL,
    "precision" integer NOT NULL,
    rounding_digit integer NOT NULL,
...
ALTER TABLE public.dcs_currency_rule OWNER TO postgres;

--
-- Name: dcs_device; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_device (
    dcs_device_id bigint NOT NULL,
    dcs_location_rcd character varying(20) NOT NULL,
    dcs_device_type_rcd character varying(20) NOT NULL,
    dcs_device_execution_location_rcd character varying(20) NOT NULL,
    device_name character varying(240),
    device_address character varying(240),
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_device OWNER TO postgres;

--
-- Name: dcs_device_execution_location_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_device_execution_location_ref (
    dcs_device_execution_location_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    orderflag integer NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
...
ALTER TABLE public.dcs_device_execution_location_ref OWNER TO postgres;

--
-- Name: dcs_device_job_action_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_device_job_action_type_ref (
    dcs_device_job_action_type_rcd character varying(20) NOT NULL,
    description character varying(240),
    orderflag integer NOT NULL,
    active_flag integer DEFAULT 0,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_device_job_action_type_ref OWNER TO postgres;

--
-- Name: dcs_device_job_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_device_job_mapping (
    dcs_device_job_mapping_id bigint NOT NULL,
    dcs_location_rcd character varying(20) NOT NULL,
    dcs_device_id bigint NOT NULL,
    dcs_device_job_action_type_rcd character varying(20) NOT NULL,
    comment character varying(240),
...
ALTER TABLE public.dcs_device_job_mapping OWNER TO postgres;

--
-- Name: dcs_device_location_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_device_location_mapping (
    dcs_device_location_mapping_id bigint NOT NULL,
    dcs_location_rcd character varying(20) NOT NULL,
    dcs_device_id bigint NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
...
ALTER TABLE public.dcs_device_location_mapping OWNER TO postgres;

--
-- Name: dcs_device_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_device_type_ref (
    dcs_device_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_device_type_ref OWNER TO postgres;

--
-- Name: dcs_dynamic_field; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_dynamic_field (
    dcs_dynamic_field_id bigint NOT NULL,
    dcs_dynamic_payment_id bigint NOT NULL,
    dcs_dynamic_field_definition_id bigint NOT NULL,
...
ALTER TABLE public.dcs_dynamic_field OWNER TO postgres;

--
-- Name: dcs_dynamic_field_definition; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_dynamic_field_definition (
    dcs_dynamic_field_definition_id bigint NOT NULL,
    dcs_dynamic_payment_routing_id bigint NOT NULL,
    dcs_dynamic_field_validation_rule_rcd character varying(20) NOT NULL,
    dcs_dynamic_field_type_rcd character varying(20) NOT NULL,
    field_name character varying(240) NOT NULL,
    xml_field_name character varying(240) NOT NULL,
    ...
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    default_value character varying(240)
);


ALTER TABLE public.dcs_dynamic_field_definition OWNER TO postgres;

--
-- Name: dcs_dynamic_field_type; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_dynamic_field_type (
    dcs_dynamic_field_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_dynamic_field_type OWNER TO postgres;

--
-- Name: dcs_dynamic_field_validation_rule_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_dynamic_field_validation_rule_ref (
    dcs_dynamic_field_validation_rule_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_dynamic_field_validation_rule_ref OWNER TO postgres;

--
-- Name: dcs_dynamic_payment; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_dynamic_payment (
    dcs_dynamic_payment_id bigint NOT NULL,
    dcs_payment_id bigint NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_dynamic_payment OWNER TO postgres;

--
-- Name: dcs_dynamic_payment_routing; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_dynamic_payment_routing (
    dcs_dynamic_payment_routing_id bigint NOT NULL,
    dcs_payment_method_rcd character varying(20) NOT NULL,
    payment_name character varying(240) NOT NULL,
    payment_service character varying(240) NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_dynamic_payment_routing OWNER TO postgres;

--
-- Name: dcs_eye_color_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_eye_color_ref (
    dcs_eye_color_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_eye_color_ref OWNER TO postgres;

--
-- Name: dcs_flight; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight (
    dcs_flight_id bigint NOT NULL,
    dcs_origin_airport_id bigint NOT NULL,
    dcs_destination_airport_id bigint NOT NULL,
    dcs_carrier_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_flight OWNER TO postgres;

--
-- Name: dcs_flight_delay_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_delay_code_ref (
    dcs_flight_delay_code_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    need_remark_flag integer DEFAULT 0,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_flight_delay_code_ref OWNER TO postgres;

--
-- Name: dcs_flight_inventory; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_inventory (
    dcs_flight_inventory_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    dcs_compartment_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_flight_inventory OWNER TO postgres;

--
-- Name: dcs_flight_landed_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_landed_ref (
    dcs_flight_landed_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_flight_landed_ref OWNER TO postgres;

--
-- Name: dcs_flight_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_mapping (
    dcs_flight_mapping_id bigint NOT NULL,
    dcs_flight_segment_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE public.dcs_flight_mapping OWNER TO postgres;

--
-- Name: dcs_flight_segment; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_segment (
    dcs_flight_segment_id bigint NOT NULL,
    dcs_carrier_rcd character varying(20) NOT NULL,
    dcs_origin_airport_id bigint NOT NULL,
    dcs_destination_airport_id bigint NOT NULL,
...
ALTER TABLE public.dcs_flight_segment OWNER TO postgres;

--
-- Name: dcs_flight_status; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_status (
    dcs_flight_status_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    dcs_flight_status_rcd character varying(20) NOT NULL,
    remarks character varying(240),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_flight_status OWNER TO postgres;

--
-- Name: dcs_flight_status_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_status_ref (
    dcs_flight_status_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_flight_status_ref OWNER TO postgres;

--
-- Name: dcs_flight_status_security_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_status_security_mapping (
    dcs_flight_status_security_mapping_id bigint NOT NULL,
    dcs_object_rcd character varying(20) NOT NULL,
    dcs_location_area_type_rcd character varying(20) NOT NULL,
    dcs_flight_status_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_flight_status_security_mapping OWNER TO postgres;

--
-- Name: dcs_flight_update; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_flight_update (
    dcs_flight_update_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    dcs_flight_landed_rcd character varying(20) NOT NULL,
    dcs_flight_delay_code_rcd character varying(20) NOT NULL,
    delay_reason_description character varying(240),
    scheduled_departure_time time with time zone,
    estimated_departure_time time with time zone,
    scheduled_arrival_time time with time zone,
    estimated_arrival_time time with time zone,
    out_of_gate_time time with time zone,
    off_ground_time time with time zone,
    on_ground_time time with time zone,
    in_gate_time time with time zone,
    arrival_fuel_on_board integer,
    departure_fuel_on_board integer,
    pilot_landed_flag integer DEFAULT 0,
    remarks character varying(240),
    supplements character varying(20),
...
ALTER TABLE public.dcs_flight_update OWNER TO postgres;

--
-- Name: dcs_gate_pass_person; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gate_pass_person (
    dcs_gate_pass_person_id bigint NOT NULL,
    dcs_passenger_id bigint NOT NULL,
    dcs_airport_id bigint NOT NULL,
    first_name character varying(240),
    middle_name character varying(240),
    last_name character varying(240),
    remarks character varying(240),
    gate_pass_number integer,
...
ALTER TABLE public.dcs_gate_pass_person OWNER TO postgres;

--
-- Name: dcs_gateway; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gateway (
    dcs_gateway_id integer NOT NULL,
    dcs_gateway_event_rcd character varying(20) NOT NULL,
    identification integer,
    book_code character varying(20),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_gateway OWNER TO postgres;

--
-- Name: dcs_gateway_action; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gateway_action (
    dcs_gateway_action_id bigint NOT NULL,
    init_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_gateway_action OWNER TO postgres;

--
-- Name: dcs_gateway_dcs_gateway_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE dcs_gateway_dcs_gateway_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.dcs_gateway_dcs_gateway_id_seq OWNER TO postgres;

--
-- Name: dcs_gateway_dcs_gateway_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE dcs_gateway_dcs_gateway_id_seq OWNED BY dcs_gateway.dcs_gateway_id;


--
-- Name: dcs_gateway_discrepancy; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gateway_discrepancy (
    dcs_gateway_discrepancy_id bigint NOT NULL,
    dcs_gateway_discrepancy_type_rcd character varying(20) NOT NULL,
    dcs_booking_id bigint NOT NULL,
    update_user character varying(5),
    update_time timestamp with time zone,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_gateway_discrepancy OWNER TO postgres;

--
-- Name: dcs_gateway_discrepancy_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gateway_discrepancy_type_ref (
    dcs_gateway_discrepancy_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_gateway_discrepancy_type_ref OWNER TO postgres;

--
-- Name: dcs_gateway_event_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gateway_event_ref (
    dcs_gateway_event_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_gateway_event_ref OWNER TO postgres;

--
-- Name: dcs_gateway_history; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gateway_history (
    dcs_gateway_history_id bigint NOT NULL,
    dcs_gateway_event_rcd character varying(20) NOT NULL,
    identification integer,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_gateway_history OWNER TO postgres;

--
-- Name: dcs_gateway_reject; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gateway_reject (
    dcs_gateway_reject_id bigint NOT NULL,
    dcs_gateway_event_rcd character varying(20) NOT NULL,
    dcs_gateway_reject_reason_rcd character varying(20) NOT NULL,
    identification integer,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE public.dcs_gateway_reject OWNER TO postgres;

--
-- Name: dcs_gateway_reject_reason_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gateway_reject_reason_ref (
    dcs_gateway_reject_reason_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_gateway_reject_reason_ref OWNER TO postgres;

--
-- Name: dcs_gender_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_gender_type_ref (
    dcs_gender_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_gender_type_ref OWNER TO postgres;

--
-- Name: dcs_group; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_group (
    dcs_group_id bigint NOT NULL,
    description character varying(240),
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_group OWNER TO postgres;

--
-- Name: dcs_group_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_group_mapping (
    dcs_group_mapping_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    dcs_group_id bigint NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
...
ALTER TABLE public.dcs_group_mapping OWNER TO postgres;

--
-- Name: dcs_hair_color_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_hair_color_ref (
    dcs_hair_color_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_hair_color_ref OWNER TO postgres;

--
-- Name: dcs_invoice; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_invoice (
    dcs_invoice_id bigint NOT NULL,
    dcs_passenger_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    dcs_currency_rule_id bigint NOT NULL,
    amount numeric(15,4) NOT NULL,
    amount_rounding_part numeric(15,4) NOT NULL,
    tax_amount numeric(15,4) NOT NULL,
    tax_amount_rounding_part numeric(15,4) NOT NULL,
...
ALTER TABLE public.dcs_invoice OWNER TO postgres;

--
-- Name: dcs_invoice_detail; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_invoice_detail (
    dcs_invoice_detail_id bigint NOT NULL,
    dcs_invoice_id bigint NOT NULL,
    dcs_cashier_charge_id bigint NOT NULL,
    dcs_currency_rule_id bigint NOT NULL,
    amount numeric(15,4) NOT NULL,
...
ALTER TABLE public.dcs_invoice_detail OWNER TO postgres;

--
-- Name: dcs_itinerary; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_itinerary (
    dcs_itinerary_id bigint NOT NULL,
    dcs_booking_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    invalidated_dcs_gateway_action_id bigint,
    ...
    dcs_class_rcd character varying(20) NOT NULL,
    leg_number integer,
    from_carrier_flight_number character varying(20),
    to_carrier_flight_number character varying(20),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    final_destination character varying(20)
);


ALTER TABLE public.dcs_itinerary OWNER TO postgres;

--
-- Name: dcs_itinerary_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_itinerary_mapping (
    dcs_itinerary_mapping_id bigint NOT NULL,
    dcs_flight_segment_id bigint NOT NULL,
    dcs_itinerary_id bigint NOT NULL,
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
...
ALTER TABLE public.dcs_itinerary_mapping OWNER TO postgres;

--
-- Name: dcs_location_area_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_location_area_ref (
    dcs_location_area_rcd character varying(20) NOT NULL,
    dcs_location_area_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_location_area_ref OWNER TO postgres;

--
-- Name: dcs_location_area_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_location_area_type_ref (
    dcs_location_area_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_location_area_type_ref OWNER TO postgres;

--
-- Name: dcs_location_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_location_ref (
    dcs_location_rcd character varying(20) NOT NULL,
    dcs_location_area_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
...
ALTER TABLE public.dcs_location_ref OWNER TO postgres;

--
-- Name: dcs_minor_escort; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_minor_escort (
    dcs_minor_escort_id bigint NOT NULL,
    name character varying(20),
    secondary_name character varying(240),
    address_street character varying(240),
    address_city character varying(240),
    address_state character varying(240),
    address_postcode character varying(20),
...
ALTER TABLE public.dcs_minor_escort OWNER TO postgres;

--
-- Name: dcs_miscellaneous_charge; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_miscellaneous_charge (
    dcs_miscellaneous_charge_id bigint NOT NULL,
    dcs_miscellaneous_charge_rule_id bigint NOT NULL,
    dcs_currency_rule_id bigint NOT NULL,
    description character varying(240),
    amount numeric(15,4) NOT NULL,
    tax_amount numeric(15,4) NOT NULL,
...
ALTER TABLE public.dcs_miscellaneous_charge OWNER TO postgres;

--
-- Name: dcs_miscellaneous_charge_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_miscellaneous_charge_ref (
    dcs_miscellaneous_charge_rcd character varying(20) NOT NULL,
    description character varying(240),
    active_flag integer DEFAULT 0,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_miscellaneous_charge_ref OWNER TO postgres;

--
-- Name: dcs_miscellaneous_charge_rule; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_miscellaneous_charge_rule (
    dcs_miscellaneous_charge_rule_id bigint NOT NULL,
    dcs_miscellaneous_charge_rcd character varying(20) NOT NULL,
    dcs_currency_rcd character varying(20) NOT NULL,
    amount numeric(15,4) NOT NULL,
    ...
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    dcs_payment_method_rcd character varying(20) DEFAULT NULL::character varying,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    effective_from_date_time timestamp with time zone,
    effective_until_date_time timestamp with time zone,
    from_dcs_airport_id bigint,
    to_dcs_airport_id bigint
);


ALTER TABLE public.dcs_miscellaneous_charge_rule OWNER TO postgres;

--
-- Name: dcs_no_fly; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_no_fly (
    dcs_no_fly_id bigint NOT NULL,
    dcs_gate_pass_person_id bigint,
    dcs_passenger_id bigint,
    dcs_no_fly_clearing_reason_code_rcd character varying(20) NOT NULL,
    comment character varying(240),
    action_taken_flag integer DEFAULT 0,
    action_comment character varying(240),
    witness character varying(240),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
...
ALTER TABLE public.dcs_no_fly OWNER TO postgres;

--
-- Name: dcs_no_fly_clearing_reason_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_no_fly_clearing_reason_code_ref (
    dcs_no_fly_clearing_reason_code_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_no_fly_clearing_reason_code_ref OWNER TO postgres;

--
-- Name: dcs_nofly_selectee_password_attempt; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_nofly_selectee_password_attempt (
    dcs_nofly_selectee_password_attempt_id bigint NOT NULL,
    dcs_no_fly_id bigint,
    dcs_selectee_id bigint,
    attempt_at_user_id bigint NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_nofly_selectee_password_attempt OWNER TO postgres;

--
-- Name: dcs_object_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_object_ref (
    dcs_object_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_object_ref OWNER TO postgres;

--
-- Name: dcs_origin; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_origin (
    dcs_origin_id integer NOT NULL,
    dcs_company_rcd character varying(20) NOT NULL,
    dcs_origin_type_rcd character varying(20) NOT NULL,
    dcs_carrier_rcd character varying(20),
...
ALTER TABLE public.dcs_origin OWNER TO postgres;

--
-- Name: dcs_origin_dcs_origin_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE dcs_origin_dcs_origin_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.dcs_origin_dcs_origin_id_seq OWNER TO postgres;

--
-- Name: dcs_origin_dcs_origin_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE dcs_origin_dcs_origin_id_seq OWNED BY dcs_origin.dcs_origin_id;


--
-- Name: dcs_origin_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_origin_ref (
    dcs_origin_rcd character varying(20) NOT NULL,
    description character varying(200),
    active_flag integer,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE public.dcs_origin_ref OWNER TO postgres;

--
-- Name: dcs_origin_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_origin_type_ref (
    dcs_origin_type_rcd character varying(20) NOT NULL,
    description character varying(240),
    active_flag integer,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_origin_type_ref OWNER TO postgres;

--
-- Name: dcs_passenger; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger (
    dcs_passenger_id bigint NOT NULL,
    dcs_booking_id bigint NOT NULL,
    invalidated_dcs_gateway_action_id bigint,
    dcs_passenger_type_rcd character varying(20),
    dcs_passenger_code_rcd character varying(20) NOT NULL,
    dcs_passenger_title_rcd character varying(20),
    passenger_number integer,
    passenger_name character varying(240),
...
ALTER TABLE public.dcs_passenger OWNER TO postgres;

--
-- Name: dcs_passenger_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_code_ref (
    dcs_passenger_code_rcd character varying(20) NOT NULL,
    dcs_priority_rcd character varying(20) NOT NULL,
    dcs_passenger_type_rcd character varying(20),
    description character varying(240) NOT NULL,
    active_flag integer NOT NULL,
    receive_coupon_flag integer,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE public.dcs_passenger_code_ref OWNER TO postgres;

--
-- Name: dcs_passenger_document; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_document (
    dcs_passenger_document_id bigint NOT NULL,
    dcs_passenger_info_id bigint NOT NULL,
    dcs_issuing_country_code_rcd character varying(20),
    dcs_passenger_document_type_rcd character varying(20),
    document_number character varying(100),
    expiration_date_time timestamp with time zone,
    issued_date_time timestamp with time zone,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    travel_document character varying(100),
    travel_document_number character varying(100),
    dcs_visa_valid_for_country_code_rcd character varying(20),
    visa_issued_place character varying(100),
    issue_date timestamp with time zone
);


ALTER TABLE public.dcs_passenger_document OWNER TO postgres;

--
-- Name: dcs_passenger_document_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_document_type_ref (
    dcs_passenger_document_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    expiry_date_mandatory_flag integer DEFAULT 0 NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_passenger_document_type_ref OWNER TO postgres;

--
-- Name: dcs_passenger_final_sales_route; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_final_sales_route (
    dcs_passenger_final_sales_route_id bigint NOT NULL,
    dcs_carrier_rcd character varying(20) NOT NULL,
    flight_number character varying(20),
    from_date date,
    until_date date,
    dcs_airport_id bigint,
    report_address character varying(240) NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_passenger_final_sales_route OWNER TO postgres;

--
-- Name: dcs_passenger_info; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_info (
    dcs_passenger_info_id bigint NOT NULL,
    dcs_passenger_id bigint NOT NULL,
    dcs_country_of_residence_rcd character varying(20),
    dcs_citizen_country_code_rcd character varying(20),
    dcs_gender_type_rcd character varying(20),
    birth_date date,
    telephone_number character varying(50),
    address character varying(240),
    address_city character varying(240),
    address_province character varying(240),
    address_postal_code character varying(240),
    emergency_contact_name character varying(240),
    emergency_contact_phone_number character varying(240),
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    address_country character varying(20),
    address_type character(1)
);


ALTER TABLE public.dcs_passenger_info OWNER TO postgres;

--
-- Name: dcs_passenger_info_request; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_info_request (
    dcs_passenger_info_request_id bigint NOT NULL,
    dcs_passenger_id bigint NOT NULL,
    dcs_passenger_info_requested_by_rcd character varying(20) NOT NULL,
    comment character varying(240),
    action_taken_flag integer DEFAULT 0 NOT NULL,
...
ALTER TABLE public.dcs_passenger_info_request OWNER TO postgres;

--
-- Name: dcs_passenger_info_requested_by_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_info_requested_by_ref (
    dcs_passenger_info_requested_by_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_passenger_info_requested_by_ref OWNER TO postgres;

--
-- Name: dcs_passenger_request; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_request (
    dcs_passenger_request_id bigint NOT NULL,
    dcs_passenger_id bigint NOT NULL,
    dcs_service_request_rid bigint NOT NULL,
    dcs_currency_rule_id bigint,
    amount numeric(15,4),
...
ALTER TABLE public.dcs_passenger_request OWNER TO postgres;

--
-- Name: dcs_passenger_request_itinerary_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_request_itinerary_mapping (
    dcs_passenger_request_itinerary_mapping_id bigint NOT NULL,
    dcs_itinerary_id bigint NOT NULL,
    dcs_passenger_request_id bigint NOT NULL
);


ALTER TABLE public.dcs_passenger_request_itinerary_mapping OWNER TO postgres;

--
-- Name: dcs_passenger_title_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_title_ref (
    dcs_passenger_title_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_passenger_title_ref OWNER TO postgres;

--
-- Name: dcs_passenger_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_type_ref (
    dcs_passenger_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_passenger_type_ref OWNER TO postgres;

--
-- Name: dcs_passenger_zone; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_zone (
    dcs_passenger_zone_id bigint NOT NULL,
    seat_map_id integer,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_passenger_zone OWNER TO postgres;

--
-- Name: dcs_passenger_zone_flight_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_zone_flight_mapping (
    dcs_passenger_zone_flight_mapping_id bigint NOT NULL,
    dcs_passenger_zone_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_passenger_zone_flight_mapping OWNER TO postgres;

--
-- Name: dcs_passenger_zone_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_zone_mapping (
    dcs_passenger_zone_mapping_id bigint NOT NULL,
    dcs_passenger_zone_type_rcd character varying(20) NOT NULL,
    dcs_passenger_zone_id bigint NOT NULL,
    from_row_number integer,
    until_row_number integer,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_passenger_zone_mapping OWNER TO postgres;

--
-- Name: dcs_passenger_zone_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_passenger_zone_type_ref (
    dcs_passenger_zone_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_passenger_zone_type_ref OWNER TO postgres;

--
-- Name: dcs_payment; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment (
    dcs_payment_id bigint NOT NULL,
    dcs_invoice_id bigint NOT NULL,
    dcs_payment_method_rcd character varying(20) NOT NULL,
    dcs_currency_rule_id bigint NOT NULL,
    ...
    amount numeric(15,4) NOT NULL,
    amount_rounding_part numeric(15,4) NOT NULL,
    receipt_printed_flag integer DEFAULT 0,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    tax_amount numeric(15,4) DEFAULT 0.0000 NOT NULL,
    tax_amount_rounding_part numeric(15,4) DEFAULT 0.0000 NOT NULL
);


ALTER TABLE public.dcs_payment OWNER TO postgres;

--
-- Name: dcs_payment_card; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_card (
    dcs_payment_creditcard_id bigint NOT NULL,
    dcs_payment_id bigint NOT NULL,
    dcs_payment_card_rcd character varying(20) NOT NULL,
    card_number character varying(20) NOT NULL,
    card_verification_value character varying(20),
    holder_name_first character varying(240) NOT NULL,
    holder_name_middle character varying(240),
    holder_name_last character varying(240),
    expiration_year integer,
    expiration_month integer,
    phone_number character varying(240),
    address character varying(240),
    address_city character varying(240),
    address_province character varying(240),
    address_postal_code character varying(240),
    address_country_code character varying(240),
...
ALTER TABLE public.dcs_payment_card OWNER TO postgres;

--
-- Name: dcs_payment_card_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_card_ref (
    dcs_payment_card_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    credit_flag integer DEFAULT 0 NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_payment_card_ref OWNER TO postgres;

--
-- Name: dcs_payment_cash; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_cash (
    dcs_payment_cash_id bigint NOT NULL,
    dcs_payment_id bigint NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_payment_cash OWNER TO postgres;

--
-- Name: dcs_payment_cheque; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_cheque (
    dcs_payment_cheque_id bigint NOT NULL,
    dcs_payment_id bigint NOT NULL,
    dcs_payment_cheque_type_rcd character varying(20) NOT NULL,
    cheque_number character varying(50),
    payor_name character varying(240),
...
ALTER TABLE public.dcs_payment_cheque OWNER TO postgres;

--
-- Name: dcs_payment_cheque_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_cheque_type_ref (
    dcs_payment_cheque_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_payment_cheque_type_ref OWNER TO postgres;

--
-- Name: dcs_payment_employee; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_employee (
    dcs_payment_employee_id bigint NOT NULL,
    results_employee_id bigint NOT NULL,
    dcs_payment_id bigint NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_payment_employee OWNER TO postgres;

--
-- Name: dcs_payment_method_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_method_ref (
    dcs_payment_method_rcd character varying(20) NOT NULL,
    description character varying(240),
    active_flag integer DEFAULT 0,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_payment_method_ref OWNER TO postgres;

--
-- Name: dcs_payment_refund; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_refund (
    dcs_payment_refund_id bigint NOT NULL,
    dcs_refunded_payment_id bigint NOT NULL,
    dcs_payment_id bigint NOT NULL,
    dcs_payment_refund_reason_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_payment_refund OWNER TO postgres;

--
-- Name: dcs_payment_refund_charge_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_refund_charge_mapping (
    dcs_payment_refund_charge_mapping_id bigint NOT NULL,
    dcs_payment_refund_id bigint NOT NULL,
    dcs_cashier_charge_id bigint NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_payment_refund_charge_mapping OWNER TO postgres;

--
-- Name: dcs_payment_refund_reason_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_refund_reason_ref (
    dcs_payment_refund_reason_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_payment_refund_reason_ref OWNER TO postgres;

--
-- Name: dcs_payment_voucher; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_payment_voucher (
    dcs_payment_voucher_id bigint NOT NULL,
    dcs_payment_id bigint NOT NULL,
    voucher_number integer NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
...
ALTER TABLE public.dcs_payment_voucher OWNER TO postgres;

--
-- Name: dcs_print_identification; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_print_identification (
    dcs_print_identification_id bigint NOT NULL,
    dcs_device_job_action_type_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_print_identification OWNER TO postgres;

--
-- Name: dcs_priority_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_priority_ref (
    dcs_priority_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_priority_ref OWNER TO postgres;

--
-- Name: dcs_queue; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_queue (
    dcs_queue_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    dcs_queue_rule_id bigint,
    dcs_priority_rcd character varying(20) NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_queue OWNER TO postgres;

--
-- Name: dcs_queue_rule; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_queue_rule (
    dcs_queue_rule_id bigint NOT NULL,
    dcs_queue_type_rcd character varying(20) NOT NULL,
    dcs_passenger_code_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_queue_rule OWNER TO postgres;

--
-- Name: dcs_queue_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_queue_type_ref (
    dcs_queue_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
...
ALTER TABLE public.dcs_queue_type_ref OWNER TO postgres;

--
-- Name: dcs_queued_flight_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_queued_flight_mapping (
    dcs_queued_flight_mapping_id bigint NOT NULL,
    dcs_queue_id bigint NOT NULL,
    dcs_flight_id bigint NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
...
ALTER TABLE public.dcs_queued_flight_mapping OWNER TO postgres;

--
-- Name: dcs_reference_tables_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_reference_tables_ref (
    dcs_reference_tables_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    table_name character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL,
    orderflag integer NOT NULL
...
ALTER TABLE public.dcs_reference_tables_ref OWNER TO postgres;

--
-- Name: dcs_requires_action_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_requires_action_type_ref (
    dcs_requires_action_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    cargo_flag integer DEFAULT 0,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_requires_action_type_ref OWNER TO postgres;

--
-- Name: dcs_search_criteria_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_search_criteria_ref (
    dcs_search_criteria_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_search_criteria_ref OWNER TO postgres;

--
-- Name: dcs_seat; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_seat (
    dcs_seat_id bigint NOT NULL,
    dcs_passenger_id bigint NOT NULL,
    dcs_itinerary_id bigint NOT NULL,
    flight_seat_reservation_id bigint NOT NULL,
    seat_number character varying(20),
    boarding_control_number character varying(20),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_seat OWNER TO postgres;

--
-- Name: dcs_seat_attribute_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_seat_attribute_ref (
    dcs_seat_attribute_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_seat_attribute_ref OWNER TO postgres;

--
-- Name: dcs_seat_attribute_rule; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_seat_attribute_rule (
    dcs_seat_attribute_rule_id bigint NOT NULL,
    dcs_seat_attribute_rcd character varying(20) NOT NULL,
    allow_flag integer DEFAULT 0,
    dcs_passenger_code_rcd character varying(20) NOT NULL,
    dcs_service_request_rid bigint NOT NULL
);


ALTER TABLE public.dcs_seat_attribute_rule OWNER TO postgres;

--
-- Name: dcs_seat_request_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_seat_request_ref (
    dcs_seat_request_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_seat_request_ref OWNER TO postgres;

--
-- Name: dcs_selectee; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_selectee (
    dcs_selectee_id bigint NOT NULL,
    dcs_passenger_id bigint,
    dcs_gate_pass_person_id bigint,
    dcs_selectee_clearing_reason_code_rcd character varying(20) NOT NULL,
...
ALTER TABLE public.dcs_selectee OWNER TO postgres;

--
-- Name: dcs_selectee_agent_reason_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_selectee_agent_reason_code_ref (
    dcs_selectee_agent_reason_code_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    need_remark_flag integer DEFAULT 0,
...
ALTER TABLE public.dcs_selectee_agent_reason_code_ref OWNER TO postgres;

--
-- Name: dcs_selectee_clearing_reason_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_selectee_clearing_reason_code_ref (
    dcs_selectee_clearing_reason_code_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_selectee_clearing_reason_code_ref OWNER TO postgres;

--
-- Name: dcs_selectee_location_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_selectee_location_code_ref (
    dcs_selectee_location_code_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_selectee_location_code_ref OWNER TO postgres;

--
-- Name: dcs_serial_number; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_serial_number (
    dcs_serial_number_id bigint NOT NULL,
    serial_number_code character varying(20),
    description character varying(240),
...
ALTER TABLE public.dcs_serial_number OWNER TO postgres;

--
-- Name: dcs_serial_number_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_serial_number_ref (
    dcs_serial_number_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_serial_number_ref OWNER TO postgres;

--
-- Name: dcs_service_request_grouping_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_service_request_grouping_ref (
    dcs_service_request_grouping_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    orderflag integer NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_service_request_grouping_ref OWNER TO postgres;

--
-- Name: dcs_service_request_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_service_request_ref (
    dcs_service_request_rid bigint NOT NULL,
    dcs_service_request_grouping_rcd character varying(20),
    dcs_requires_action_type_rcd character varying(20) NOT NULL,
    service_request_code character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    create_user character varying(5) NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_service_request_ref OWNER TO postgres;

--
-- Name: dcs_setting; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_setting (
    dcs_setting_code character varying(20) NOT NULL,
    dcs_setting_value character varying(20),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_setting OWNER TO postgres;

--
-- Name: dcs_sfpd_action; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_sfpd_action (
    dcs_sfpd_action_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    invalidated_dcs_gateway_action_id bigint,
    flight_seq_no integer,
    sfpd_description character varying(50),
    cbp_sent character(1),
    submit_date_time timestamp with time zone,
    cbp_reply character varying(200),
    reply_date_time timestamp with time zone,
...
ALTER TABLE public.dcs_sfpd_action OWNER TO postgres;

--
-- Name: dcs_tail_swap_history; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_tail_swap_history (
    dcs_tail_swap_history_id integer NOT NULL,
    dcs_flight_id bigint NOT NULL,
    swap_to_tail_number character varying(50) NOT NULL,
    aircraft_code_from character varying(7) NOT NULL,
    aircraft_code_to character varying(7) NOT NULL,
    user_name character varying(240) NOT NULL,
    update_time character varying(19) NOT NULL
);


ALTER TABLE public.dcs_tail_swap_history OWNER TO postgres;

--
-- Name: dcs_tail_swap_history_dcs_tail_swap_history_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE dcs_tail_swap_history_dcs_tail_swap_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.dcs_tail_swap_history_dcs_tail_swap_history_id_seq OWNER TO postgres;

--
-- Name: dcs_tail_swap_history_dcs_tail_swap_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE dcs_tail_swap_history_dcs_tail_swap_history_id_seq OWNED BY dcs_tail_swap_history.dcs_tail_swap_history_id;


--
-- Name: dcs_unaccompanied_minor; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_unaccompanied_minor (
    dcs_unaccompanied_minor_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    dcs_origin_escort_id bigint NOT NULL,
    dcs_destination_escort_id bigint NOT NULL,
    dcs_hair_color_rcd character varying(20) NOT NULL,
    dcs_eye_color_rcd character varying(20) NOT NULL,
    dcs_gender_type_rcd character varying(20) NOT NULL,
    ...
    age integer,
    clothing character varying(240),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_unaccompanied_minor OWNER TO postgres;

--
-- Name: dcs_unseated_passenger_type_escort_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_unseated_passenger_type_escort_mapping (
    dcs_unseated_passenger_type_escort_mapping_id bigint NOT NULL,
    dcs_passenger_code_rcd character varying(20) NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_unseated_passenger_type_escort_mapping OWNER TO postgres;

--
-- Name: dcs_unseated_passenger_type_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_unseated_passenger_type_mapping (
    dcs_unseated_passenger_type_mapping_id bigint NOT NULL,
    dcs_passenger_code_rcd character varying(20) NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_unseated_passenger_type_mapping OWNER TO postgres;

--
-- Name: dcs_upgrade; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_upgrade (
    dcs_upgrade_id bigint NOT NULL,
    dcs_upgrade_rule_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    amount numeric(15,4) NOT NULL,
    tax_amount numeric(15,4) NOT NULL,
    invalid_user character varying(5),
...
ALTER TABLE public.dcs_upgrade OWNER TO postgres;

--
-- Name: dcs_upgrade_rule; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_upgrade_rule (
    dcs_upgrade_rule_id bigint NOT NULL,
    dcs_origin_airport_id bigint,
    dcs_destination_airport_id bigint,
    dcs_currency_rcd character varying(20) NOT NULL,
    dcs_class_rcd character varying(20) NOT NULL,
    active_from_date_time timestamp with time zone,
    active_until_date_time timestamp with time zone,
    days_of_week character(7),
    carrier_flight_number character varying(20),
    selling_amount numeric(15,4) NOT NULL,
    tax_amount numeric(15,4) NOT NULL,
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
    create_user character varying(5) NOT NULL,
...
ALTER TABLE public.dcs_upgrade_rule OWNER TO postgres;

--
-- Name: dcs_user; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_user (
    dcs_user_id bigint NOT NULL,
    user_code character varying(20),
    user_name character varying(240),
    results_last_destination_id character varying(20),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dcs_user OWNER TO postgres;

--
-- Name: dcs_user_location_mapping; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_user_location_mapping (
    dcs_user_location_mapping_id bigint NOT NULL,
    dcs_location_rcd character varying(20) NOT NULL,
    dcs_user_id bigint NOT NULL,
    invalid_time timestamp with time zone,
    invalid_user character varying(5),
...
ALTER TABLE public.dcs_user_location_mapping OWNER TO postgres;

--
-- Name: dcs_user_setting; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_user_setting (
    dcs_user_setting_id bigint NOT NULL,
    dcs_user_id bigint NOT NULL,
    dcs_user_setting_code_rcd character varying(20) NOT NULL,
    value character varying(240),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE public.dcs_user_setting OWNER TO postgres;

--
-- Name: dcs_user_setting_code_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_user_setting_code_ref (
    dcs_user_setting_code_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_user_setting_code_ref OWNER TO postgres;

--
-- Name: dcs_user_setting_window; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_user_setting_window (
    dcs_user_setting_window_id bigint NOT NULL,
    window_name character varying(240) NOT NULL,
...
ALTER TABLE public.dcs_user_setting_window OWNER TO postgres;

--
-- Name: dcs_volunteer; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_volunteer (
    dcs_volunteer_id bigint NOT NULL,
    dcs_checkin_id bigint NOT NULL,
    remarks character varying(240),
    invalid_user character varying(5),
    invalid_time timestamp with time zone,
...
ALTER TABLE public.dcs_volunteer OWNER TO postgres;

--
-- Name: dcs_waive_reason_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_waive_reason_ref (
    dcs_waive_reason_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer DEFAULT 0 NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_waive_reason_ref OWNER TO postgres;

--
-- Name: dcs_weight_conversion; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_weight_conversion (
    dcs_weight_conversion_id bigint NOT NULL,
    dcs_weight_type_rcd character varying(20) NOT NULL,
    factor numeric(15,4),
    create_user character varying(5) NOT NULL,
    create_time timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.dcs_weight_conversion OWNER TO postgres;

--
-- Name: dcs_weight_type_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dcs_weight_type_ref (
    dcs_weight_type_rcd character varying(20) NOT NULL,
    description character varying(240) NOT NULL,
    active_flag integer NOT NULL,
    orderflag integer NOT NULL,
...
ALTER TABLE public.dcs_weight_type_ref OWNER TO postgres;

--
-- Name: dd_sample; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE dd_sample (
    c1 character(2) NOT NULL,
    c2 character(2),
    c3 character(2),
    c4 character(2),
    c5 character(2),
...
ALTER TABLE public.dd_sample OWNER TO postgres;
...
CREATE TABLE document_category (
    ...
    initial_deposit_value numeric(12,2),
...
CREATE TABLE fare_codes (
    ...
    user_name character(5) NOT NULL,
...
CREATE TABLE fare_segm (
    ...
    eff_to_date date,
    fare_value numeric(15,5) NOT NULL,
    user_name character(8) NOT NULL,
    group_name character(8) NOT NULL,
    update_time timestamp with time zone,
    active_flag character(1) DEFAULT 'A'::bpchar NOT NULL,
...
CREATE TABLE fee (
    ...
    min_fee_value numeric(12,2),
    max_fee_value numeric(12,2),
...
CREATE TABLE floating_definition (
    ...
    depart_airport character(3) NOT NULL,
    arrive_airport character(3) NOT NULL,
    ...
    oneway_low_limit_amount numeric(12,5) NOT NULL,
    return_low_limit_amount numeric(12,5) NOT NULL,
    oneway_upgrade_amount numeric(12,5) NOT NULL,
    return_upgrade_amount numeric(12,5) NOT NULL,
    oneway_premium_amount numeric(12,5) NOT NULL,
    return_premium_amount numeric(12,5) NOT NULL,
...
CREATE TABLE forced_fare (
    ...
    fare_amount numeric(12,5) NOT NULL,
...
CREATE TABLE invoices (
    ...
    print_stat_flag character(1) NOT NULL,
    create_user character(5) NOT NULL,
    create_group character(8) NOT NULL,
    create_time character(19) NOT NULL
);
...
--
-- Name: load_dcs_clear_list; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE load_dcs_clear_list (
    dcs_clear_list_id bigint NOT NULL,
    sid integer NOT NULL,
    cleared character varying(100),
    lastname character varying(80),
...
ALTER TABLE public.load_dcs_clear_list OWNER TO postgres;
...
CREATE TABLE misc_charge (
    ...
    charge_amount numeric(9,5) NOT NULL,
...
--
-- Name: payments_dcs_ref; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE payments_dcs_ref (
    dcs_payment_id bigint NOT NULL,
    payment_no integer NOT NULL,
    create_time character(19) NOT NULL
);
...
ALTER TABLE public.payments_dcs_ref OWNER TO postgres;
...
--
-- Name: processed_et; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE processed_et (
    et_serial_no integer NOT NULL,
    et_sequence_no smallint NOT NULL,
    key_code character(5) NOT NULL,
    book_no integer NOT NULL,
...
ALTER TABLE public.processed_et OWNER TO postgres;
...
--
-- Name: qu_par; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE qu_par (
    keyword character(60) NOT NULL,
    section character(30) NOT NULL,
    value character varying(250),
    description character varying(100)
);


ALTER TABLE public.qu_par OWNER TO postgres;
...
--
-- Name: queue_printer_dtls; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE queue_printer_dtls (
    queue_code character(5) NOT NULL,
    enable_print character(1) NOT NULL,
    dest_id character(8) NOT NULL,
    update_user character(5) NOT NULL,
    update_group character(8) NOT NULL,
    update_time timestamp with time zone
...
ALTER TABLE public.queue_printer_dtls OWNER TO postgres;
...
CREATE TABLE reallocation_request_flights (
    ...
    other_depart_airport character(3),
    other_depart_city character(3),
    other_arrive_airport character(3),
    other_arrive_city character(3),
    other_depart_time smallint,
    other_arrive_time smallint,
...
--
-- Name: recycle_book_nos; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE recycle_book_nos (
    book_no integer NOT NULL
);


ALTER TABLE public.recycle_book_nos OWNER TO postgres;

--
-- Name: recycle_book_nos_book_no_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE recycle_book_nos_book_no_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.recycle_book_nos_book_no_seq OWNER TO postgres;

--
-- Name: recycle_book_nos_book_no_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE recycle_book_nos_book_no_seq OWNED BY recycle_book_nos.book_no;


--
-- Name: recycle_client_nos; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE recycle_client_nos (
    client_id integer NOT NULL
);


ALTER TABLE public.recycle_client_nos OWNER TO postgres;

--
-- Name: recycle_client_nos_client_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE recycle_client_nos_client_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.recycle_client_nos_client_id_seq OWNER TO postgres;

--
-- Name: recycle_client_nos_client_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE recycle_client_nos_client_id_seq OWNED BY recycle_client_nos.client_id;
...
CREATE TABLE restrict_rule (
    ...
    flight_number character(7),
    start_city character(5),
    end_city character(5),
    start_date date,
    end_date date,
    frequency_code character(7),
...
CREATE TABLE state (
    ...
    nation_code character(2) NOT NULL,
    summ_start_date date NOT NULL,
    wint_start_date date NOT NULL,
    sgmt_diff_mns smallint NOT NULL,
    wgmt_diff_mns smallint NOT NULL,
    user_name character(16) NOT NULL,
    user_group character(8) NOT NULL,
    update_time timestamp with time zone
);
...
--
-- Name: sys_external; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE sys_external (
    con_key character(5) NOT NULL,
    con_type character(1) NOT NULL,
    param_1 character(20),
    param_2 character(20),
    param_3 character(20),
    param_4 character(20),
    param_5 character(20),
    update_user character(5) NOT NULL,
    update_group character(8) NOT NULL,
    update_time timestamp with time zone
);
...
ALTER TABLE public.sys_external OWNER TO postgres;
...
--
-- Name: systemname; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.systemname OWNER TO postgres;
...
CREATE TABLE tax_category (
    ...
    valid_from_date date NOT NULL,
    valid_to_date date NOT NULL,
    oneway_cap_value numeric(12,2) NOT NULL,
    return_cap_value numeric(12,2) NOT NULL,
...
--
-- Name: tckt_serial_nos; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE tckt_serial_nos (
    tckt_serial_no integer NOT NULL,
    create_user character(5) NOT NULL,
    create_group character(8) NOT NULL,
    create_time character(19) NOT NULL
);
...
ALTER TABLE public.tckt_serial_nos OWNER TO postgres;

--
-- Name: tckt_serial_nos_tckt_serial_no_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE tckt_serial_nos_tckt_serial_no_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.tckt_serial_nos_tckt_serial_no_seq OWNER TO postgres;

--
-- Name: tckt_serial_nos_tckt_serial_no_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE tckt_serial_nos_tckt_serial_no_seq OWNED BY tckt_serial_nos.tckt_serial_no;
...
--
-- Name: user_names; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: dcs_gateway_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY dcs_gateway ALTER COLUMN dcs_gateway_id SET DEFAULT nextval('dcs_gateway_dcs_gateway_id_seq'::regclass);


--
-- Name: dcs_origin_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY dcs_origin ALTER COLUMN dcs_origin_id SET DEFAULT nextval('dcs_origin_dcs_origin_id_seq'::regclass);


--
-- Name: dcs_tail_swap_history_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY dcs_tail_swap_history ALTER COLUMN dcs_tail_swap_history_id SET DEFAULT nextval('dcs_tail_swap_history_dcs_tail_swap_history_id_seq'::regclass);
...
ALTER TABLE ONLY recycle_book_nos ALTER COLUMN book_no SET DEFAULT nextval('recycle_book_nos_book_no_seq'::regclass);
...
ALTER TABLE ONLY recycle_client_nos ALTER COLUMN client_id SET DEFAULT nextval('recycle_client_nos_client_id_seq'::regclass);
...
--
-- Name: tckt_serial_no; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY tckt_serial_nos ALTER COLUMN tckt_serial_no SET DEFAULT nextval('tckt_serial_nos_tckt_serial_no_seq'::regclass);
...
--
-- Name: dcs_action_security_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_action_security_mapping
    ADD CONSTRAINT dcs_action_security_mapping_pkey PRIMARY KEY (dcs_action_security_mapping_id);


--
-- Name: dcs_action_security_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_action_security_ref
    ADD CONSTRAINT dcs_action_security_ref_pkey PRIMARY KEY (dcs_action_security_rcd);


--
-- Name: dcs_aircraft_config_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_aircraft_config_ref
    ADD CONSTRAINT dcs_aircraft_config_ref_pkey PRIMARY KEY (dcs_aircraft_config_rcd);


--
-- Name: dcs_airport_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_airport
    ADD CONSTRAINT dcs_airport_pkey PRIMARY KEY (dcs_airport_id);


--
-- Name: dcs_amendment_reason_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_amendment_reason_code_ref
    ADD CONSTRAINT dcs_amendment_reason_code_ref_pkey PRIMARY KEY (dcs_amendment_reason_code_rcd);


--
-- Name: dcs_apis_action_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_apis_action
    ADD CONSTRAINT dcs_apis_action_pkey PRIMARY KEY (dcs_apis_action_id);


--
-- Name: dcs_apis_carrier_contact_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_apis_carrier_contact
    ADD CONSTRAINT dcs_apis_carrier_contact_pkey PRIMARY KEY (dcs_apis_carrier_contact_id);


--
-- Name: dcs_apis_flight_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_apis_flight
    ADD CONSTRAINT dcs_apis_flight_pkey PRIMARY KEY (dcs_apisflight_id);


--
-- Name: dcs_apisaction_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_apisaction
    ADD CONSTRAINT dcs_apisaction_pkey PRIMARY KEY (dcs_apisaction_id);


--
-- Name: dcs_aux_document_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_aux_document
    ADD CONSTRAINT dcs_aux_document_pkey PRIMARY KEY (dcs_passenger_document_id);


--
-- Name: dcs_baggage_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_baggage_code_ref
    ADD CONSTRAINT dcs_baggage_code_ref_pkey PRIMARY KEY (dcs_baggage_code_rcd);


--
-- Name: dcs_baggage_color_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_baggage_color_ref
    ADD CONSTRAINT dcs_baggage_color_ref_pkey PRIMARY KEY (dcs_baggage_color_rcd);


--
-- Name: dcs_baggage_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_baggage
    ADD CONSTRAINT dcs_baggage_pkey PRIMARY KEY (dcs_baggage_id);


--
-- Name: dcs_baggage_rule_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_baggage_rule
    ADD CONSTRAINT dcs_baggage_rule_pkey PRIMARY KEY (dcs_baggage_rule_id);


--
-- Name: dcs_baggage_rule_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_baggage_rule_type_ref
    ADD CONSTRAINT dcs_baggage_rule_type_ref_pkey PRIMARY KEY (dcs_baggage_rule_type_rcd);


--
-- Name: dcs_baggage_status_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_baggage_status
    ADD CONSTRAINT dcs_baggage_status_pkey PRIMARY KEY (dcs_baggage_status_id);


--
-- Name: dcs_baggage_status_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_baggage_status_ref
    ADD CONSTRAINT dcs_baggage_status_ref_pkey PRIMARY KEY (dcs_baggage_status_rcd);


--
-- Name: dcs_boarding_itinerary_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_boarding_itinerary_mapping
    ADD CONSTRAINT dcs_boarding_itinerary_mapping_pkey PRIMARY KEY (dcs_boarding_itinerary_mapping_id);


--
-- Name: dcs_boarding_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_boarding
    ADD CONSTRAINT dcs_boarding_pkey PRIMARY KEY (dcs_boarding_id);


--
-- Name: dcs_boarding_print_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_boarding_print
    ADD CONSTRAINT dcs_boarding_print_pkey PRIMARY KEY (dcs_boarding_print_id);


--
-- Name: dcs_boarding_print_reason_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_boarding_print_reason_ref
    ADD CONSTRAINT dcs_boarding_print_reason_ref_pkey PRIMARY KEY (dcs_boarding_print_reason_rcd);


--
-- Name: dcs_boarding_status_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_boarding_status
    ADD CONSTRAINT dcs_boarding_status_pkey PRIMARY KEY (dcs_boarding_status_id);


--
-- Name: dcs_boarding_status_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_boarding_status_ref
    ADD CONSTRAINT dcs_boarding_status_ref_pkey PRIMARY KEY (dcs_boarding_status_rcd);


--
-- Name: dcs_boarding_zone_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_boarding_zone
    ADD CONSTRAINT dcs_boarding_zone_pkey PRIMARY KEY (dcs_boarding_zone_id);


--
-- Name: dcs_booking_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_booking
    ADD CONSTRAINT dcs_booking_pkey PRIMARY KEY (dcs_booking_id);


--
-- Name: dcs_booking_remark_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_booking_remark
    ADD CONSTRAINT dcs_booking_remark_pkey PRIMARY KEY (dcs_booking_remark_id);


--
-- Name: dcs_cargo_bin_field_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_cargo_bin_field
    ADD CONSTRAINT dcs_cargo_bin_field_pkey PRIMARY KEY (dcs_cargo_bin_field_id);


--
-- Name: dcs_cargo_bin_field_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_cargo_bin_field_ref
    ADD CONSTRAINT dcs_cargo_bin_field_ref_pkey PRIMARY KEY (dcs_cargo_bin_field_rcd);


--
-- Name: dcs_cargo_bin_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_cargo_bin_mapping
    ADD CONSTRAINT dcs_cargo_bin_mapping_pkey PRIMARY KEY (dcs_cargo_bin_mapping_id);


--
-- Name: dcs_cargo_bin_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_cargo_bin
    ADD CONSTRAINT dcs_cargo_bin_pkey PRIMARY KEY (dcs_cargo_bin_id);


--
-- Name: dcs_cargo_bin_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_cargo_bin_ref
    ADD CONSTRAINT dcs_cargo_bin_ref_pkey PRIMARY KEY (dcs_cargo_bin_rcd);


--
-- Name: dcs_carrier_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_carrier_ref
    ADD CONSTRAINT dcs_carrier_ref_pkey PRIMARY KEY (dcs_carrier_rcd);


--
-- Name: dcs_cashier_charge_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_cashier_charge
    ADD CONSTRAINT dcs_cashier_charge_pkey PRIMARY KEY (dcs_cashier_charge_id);


--
-- Name: dcs_cashier_charge_waive_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_cashier_charge_waive
    ADD CONSTRAINT dcs_cashier_charge_waive_pkey PRIMARY KEY (dcs_cashier_charge_waive_id);


--
-- Name: dcs_charge_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_charge_type_ref
    ADD CONSTRAINT dcs_charge_type_ref_pkey PRIMARY KEY (dcs_charge_type_rcd);


--
-- Name: dcs_checkin_action_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_checkin_action
    ADD CONSTRAINT dcs_checkin_action_pkey PRIMARY KEY (dcs_checkin_action_id);


--
-- Name: dcs_checkin_action_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_checkin_action_type_ref
    ADD CONSTRAINT dcs_checkin_action_type_ref_pkey PRIMARY KEY (dcs_checkin_action_type_rcd);


--
-- Name: dcs_checkin_amendment_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_checkin_amendment
    ADD CONSTRAINT dcs_checkin_amendment_pkey PRIMARY KEY (dcs_checkin_amendment_id);


--
-- Name: dcs_checkin_info_request_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_checkin_info_request
    ADD CONSTRAINT dcs_checkin_info_request_pkey PRIMARY KEY (dcs_checkin_info_request_id);


--
-- Name: dcs_checkin_itinerary_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_checkin_itinerary_mapping
    ADD CONSTRAINT dcs_checkin_itinerary_mapping_pkey PRIMARY KEY (dcs_checkin_itinerary_mapping_id);


--
-- Name: dcs_checkin_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_checkin
    ADD CONSTRAINT dcs_checkin_pkey PRIMARY KEY (dcs_checkin_id);


--
-- Name: dcs_checkin_selectee_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_checkin_selectee
    ADD CONSTRAINT dcs_checkin_selectee_pkey PRIMARY KEY (dcs_selectee_id);


--
-- Name: dcs_checkin_status_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_checkin_status_ref
    ADD CONSTRAINT dcs_checkin_status_ref_pkey PRIMARY KEY (dcs_checkin_status_rcd);


--
-- Name: dcs_class_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_class_ref
    ADD CONSTRAINT dcs_class_ref_pkey PRIMARY KEY (dcs_class_rcd);


--
-- Name: dcs_clear_list_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_clear_list
    ADD CONSTRAINT dcs_clear_list_pkey PRIMARY KEY (dcs_clear_list_id);


--
-- Name: dcs_company_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_company_ref
    ADD CONSTRAINT dcs_company_ref_pkey PRIMARY KEY (dcs_company_rcd);


--
-- Name: dcs_compartment_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_compartment_ref
    ADD CONSTRAINT dcs_compartment_ref_pkey PRIMARY KEY (dcs_compartment_rcd);


--
-- Name: dcs_country_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_country_code_ref
    ADD CONSTRAINT dcs_country_code_ref_pkey PRIMARY KEY (dcs_country_code_rcd);


--
-- Name: dcs_coupon_configuration_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_coupon_configuration
    ADD CONSTRAINT dcs_coupon_configuration_pkey PRIMARY KEY (dcs_coupon_configuration_id);


--
-- Name: dcs_coupon_group_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_coupon_group_mapping
    ADD CONSTRAINT dcs_coupon_group_mapping_pkey PRIMARY KEY (dcs_coupon_group_mapping_id);


--
-- Name: dcs_coupon_group_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_coupon_group
    ADD CONSTRAINT dcs_coupon_group_pkey PRIMARY KEY (dcs_coupon_group_id);


--
-- Name: dcs_coupon_invalidated_reason_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_coupon_invalidated_reason_ref
    ADD CONSTRAINT dcs_coupon_invalidated_reason_ref_pkey PRIMARY KEY (dcs_coupon_invalidated_reason_rcd);


--
-- Name: dcs_coupon_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_coupon
    ADD CONSTRAINT dcs_coupon_pkey PRIMARY KEY (dcs_coupon_id);


--
-- Name: dcs_coupon_reason_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_coupon_reason_code_ref
    ADD CONSTRAINT dcs_coupon_reason_code_ref_pkey PRIMARY KEY (dcs_coupon_reason_code_rcd);


--
-- Name: dcs_coupon_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_coupon_type_ref
    ADD CONSTRAINT dcs_coupon_type_ref_pkey PRIMARY KEY (dcs_coupon_type_rcd);


--
-- Name: dcs_currency_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_currency_ref
    ADD CONSTRAINT dcs_currency_ref_pkey PRIMARY KEY (dcs_currency_rcd);


--
-- Name: dcs_currency_rule_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_currency_rule
    ADD CONSTRAINT dcs_currency_rule_pkey PRIMARY KEY (dcs_currency_rule_id);


--
-- Name: dcs_device_execution_location_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_device_execution_location_ref
    ADD CONSTRAINT dcs_device_execution_location_ref_pkey PRIMARY KEY (dcs_device_execution_location_rcd);


--
-- Name: dcs_device_job_action_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_device_job_action_type_ref
    ADD CONSTRAINT dcs_device_job_action_type_ref_pkey PRIMARY KEY (dcs_device_job_action_type_rcd);


--
-- Name: dcs_device_job_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_device_job_mapping
    ADD CONSTRAINT dcs_device_job_mapping_pkey PRIMARY KEY (dcs_device_job_mapping_id);


--
-- Name: dcs_device_location_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_device_location_mapping
    ADD CONSTRAINT dcs_device_location_mapping_pkey PRIMARY KEY (dcs_device_location_mapping_id);


--
-- Name: dcs_device_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_device
    ADD CONSTRAINT dcs_device_pkey PRIMARY KEY (dcs_device_id);


--
-- Name: dcs_device_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_device_type_ref
    ADD CONSTRAINT dcs_device_type_ref_pkey PRIMARY KEY (dcs_device_type_rcd);


--
-- Name: dcs_dynamic_field_definition_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_dynamic_field_definition
    ADD CONSTRAINT dcs_dynamic_field_definition_pkey PRIMARY KEY (dcs_dynamic_field_definition_id);


--
-- Name: dcs_dynamic_field_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_dynamic_field
    ADD CONSTRAINT dcs_dynamic_field_pkey PRIMARY KEY (dcs_dynamic_field_id);


--
-- Name: dcs_dynamic_field_type_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_dynamic_field_type
    ADD CONSTRAINT dcs_dynamic_field_type_pkey PRIMARY KEY (dcs_dynamic_field_type_rcd);


--
-- Name: dcs_dynamic_field_validation_rule_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_dynamic_field_validation_rule_ref
    ADD CONSTRAINT dcs_dynamic_field_validation_rule_ref_pkey PRIMARY KEY (dcs_dynamic_field_validation_rule_rcd);


--
-- Name: dcs_dynamic_payment_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_dynamic_payment
    ADD CONSTRAINT dcs_dynamic_payment_pkey PRIMARY KEY (dcs_dynamic_payment_id);


--
-- Name: dcs_dynamic_payment_routing_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_dynamic_payment_routing
    ADD CONSTRAINT dcs_dynamic_payment_routing_pkey PRIMARY KEY (dcs_dynamic_payment_routing_id);


--
-- Name: dcs_eye_color_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_eye_color_ref
    ADD CONSTRAINT dcs_eye_color_ref_pkey PRIMARY KEY (dcs_eye_color_rcd);


--
-- Name: dcs_flight_delay_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_delay_code_ref
    ADD CONSTRAINT dcs_flight_delay_code_ref_pkey PRIMARY KEY (dcs_flight_delay_code_rcd);


--
-- Name: dcs_flight_inventory_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_inventory
    ADD CONSTRAINT dcs_flight_inventory_pkey PRIMARY KEY (dcs_flight_inventory_id);


--
-- Name: dcs_flight_landed_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_landed_ref
    ADD CONSTRAINT dcs_flight_landed_ref_pkey PRIMARY KEY (dcs_flight_landed_rcd);


--
-- Name: dcs_flight_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_mapping
    ADD CONSTRAINT dcs_flight_mapping_pkey PRIMARY KEY (dcs_flight_mapping_id);


--
-- Name: dcs_flight_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight
    ADD CONSTRAINT dcs_flight_pkey PRIMARY KEY (dcs_flight_id);


--
-- Name: dcs_flight_segment_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_segment
    ADD CONSTRAINT dcs_flight_segment_pkey PRIMARY KEY (dcs_flight_segment_id);


--
-- Name: dcs_flight_status_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_status
    ADD CONSTRAINT dcs_flight_status_pkey PRIMARY KEY (dcs_flight_status_id);


--
-- Name: dcs_flight_status_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_status_ref
    ADD CONSTRAINT dcs_flight_status_ref_pkey PRIMARY KEY (dcs_flight_status_rcd);


--
-- Name: dcs_flight_status_security_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_status_security_mapping
    ADD CONSTRAINT dcs_flight_status_security_mapping_pkey PRIMARY KEY (dcs_flight_status_security_mapping_id);


--
-- Name: dcs_flight_update_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_flight_update
    ADD CONSTRAINT dcs_flight_update_pkey PRIMARY KEY (dcs_flight_update_id);


--
-- Name: dcs_gate_pass_person_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gate_pass_person
    ADD CONSTRAINT dcs_gate_pass_person_pkey PRIMARY KEY (dcs_gate_pass_person_id);


--
-- Name: dcs_gateway_action_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gateway_action
    ADD CONSTRAINT dcs_gateway_action_pkey PRIMARY KEY (dcs_gateway_action_id);


--
-- Name: dcs_gateway_discrepancy_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gateway_discrepancy
    ADD CONSTRAINT dcs_gateway_discrepancy_pkey PRIMARY KEY (dcs_gateway_discrepancy_id);


--
-- Name: dcs_gateway_discrepancy_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gateway_discrepancy_type_ref
    ADD CONSTRAINT dcs_gateway_discrepancy_type_ref_pkey PRIMARY KEY (dcs_gateway_discrepancy_type_rcd);


--
-- Name: dcs_gateway_event_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gateway_event_ref
    ADD CONSTRAINT dcs_gateway_event_ref_pkey PRIMARY KEY (dcs_gateway_event_rcd);


--
-- Name: dcs_gateway_history_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gateway_history
    ADD CONSTRAINT dcs_gateway_history_pkey PRIMARY KEY (dcs_gateway_history_id);


--
-- Name: dcs_gateway_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gateway
    ADD CONSTRAINT dcs_gateway_pkey PRIMARY KEY (dcs_gateway_id);


--
-- Name: dcs_gateway_reject_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gateway_reject
    ADD CONSTRAINT dcs_gateway_reject_pkey PRIMARY KEY (dcs_gateway_reject_id);


--
-- Name: dcs_gateway_reject_reason_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gateway_reject_reason_ref
    ADD CONSTRAINT dcs_gateway_reject_reason_ref_pkey PRIMARY KEY (dcs_gateway_reject_reason_rcd);


--
-- Name: dcs_gender_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_gender_type_ref
    ADD CONSTRAINT dcs_gender_type_ref_pkey PRIMARY KEY (dcs_gender_type_rcd);


--
-- Name: dcs_group_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_group_mapping
    ADD CONSTRAINT dcs_group_mapping_pkey PRIMARY KEY (dcs_group_mapping_id);


--
-- Name: dcs_group_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_group
    ADD CONSTRAINT dcs_group_pkey PRIMARY KEY (dcs_group_id);


--
-- Name: dcs_hair_color_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_hair_color_ref
    ADD CONSTRAINT dcs_hair_color_ref_pkey PRIMARY KEY (dcs_hair_color_rcd);


--
-- Name: dcs_invoice_detail_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_invoice_detail
    ADD CONSTRAINT dcs_invoice_detail_pkey PRIMARY KEY (dcs_invoice_detail_id);


--
-- Name: dcs_invoice_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_invoice
    ADD CONSTRAINT dcs_invoice_pkey PRIMARY KEY (dcs_invoice_id);


--
-- Name: dcs_itinerary_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_itinerary_mapping
    ADD CONSTRAINT dcs_itinerary_mapping_pkey PRIMARY KEY (dcs_itinerary_mapping_id);


--
-- Name: dcs_itinerary_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_itinerary
    ADD CONSTRAINT dcs_itinerary_pkey PRIMARY KEY (dcs_itinerary_id);


--
-- Name: dcs_location_area_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_location_area_ref
    ADD CONSTRAINT dcs_location_area_ref_pkey PRIMARY KEY (dcs_location_area_rcd);


--
-- Name: dcs_location_area_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_location_area_type_ref
    ADD CONSTRAINT dcs_location_area_type_ref_pkey PRIMARY KEY (dcs_location_area_type_rcd);


--
-- Name: dcs_location_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_location_ref
    ADD CONSTRAINT dcs_location_ref_pkey PRIMARY KEY (dcs_location_rcd);


--
-- Name: dcs_minor_escort_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_minor_escort
    ADD CONSTRAINT dcs_minor_escort_pkey PRIMARY KEY (dcs_minor_escort_id);


--
-- Name: dcs_miscellaneous_charge_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_miscellaneous_charge
    ADD CONSTRAINT dcs_miscellaneous_charge_pkey PRIMARY KEY (dcs_miscellaneous_charge_id);


--
-- Name: dcs_miscellaneous_charge_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_miscellaneous_charge_ref
    ADD CONSTRAINT dcs_miscellaneous_charge_ref_pkey PRIMARY KEY (dcs_miscellaneous_charge_rcd);


--
-- Name: dcs_miscellaneous_charge_rule_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_miscellaneous_charge_rule
    ADD CONSTRAINT dcs_miscellaneous_charge_rule_pkey PRIMARY KEY (dcs_miscellaneous_charge_rule_id);


--
-- Name: dcs_no_fly_clearing_reason_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_no_fly_clearing_reason_code_ref
    ADD CONSTRAINT dcs_no_fly_clearing_reason_code_ref_pkey PRIMARY KEY (dcs_no_fly_clearing_reason_code_rcd);


--
-- Name: dcs_no_fly_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_no_fly
    ADD CONSTRAINT dcs_no_fly_pkey PRIMARY KEY (dcs_no_fly_id);


--
-- Name: dcs_nofly_selectee_password_attempt_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_nofly_selectee_password_attempt
    ADD CONSTRAINT dcs_nofly_selectee_password_attempt_pkey PRIMARY KEY (dcs_nofly_selectee_password_attempt_id);


--
-- Name: dcs_object_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_object_ref
    ADD CONSTRAINT dcs_object_ref_pkey PRIMARY KEY (dcs_object_rcd);


--
-- Name: dcs_origin_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_origin
    ADD CONSTRAINT dcs_origin_pkey PRIMARY KEY (dcs_origin_id);


--
-- Name: dcs_origin_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_origin_ref
    ADD CONSTRAINT dcs_origin_ref_pkey PRIMARY KEY (dcs_origin_rcd);


--
-- Name: dcs_origin_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_origin_type_ref
    ADD CONSTRAINT dcs_origin_type_ref_pkey PRIMARY KEY (dcs_origin_type_rcd);


--
-- Name: dcs_passenger_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_code_ref
    ADD CONSTRAINT dcs_passenger_code_ref_pkey PRIMARY KEY (dcs_passenger_code_rcd);


--
-- Name: dcs_passenger_document_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_document
    ADD CONSTRAINT dcs_passenger_document_pkey PRIMARY KEY (dcs_passenger_document_id);


--
-- Name: dcs_passenger_document_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_document_type_ref
    ADD CONSTRAINT dcs_passenger_document_type_ref_pkey PRIMARY KEY (dcs_passenger_document_type_rcd);


--
-- Name: dcs_passenger_final_sales_route_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_final_sales_route
    ADD CONSTRAINT dcs_passenger_final_sales_route_pkey PRIMARY KEY (dcs_passenger_final_sales_route_id);


--
-- Name: dcs_passenger_info_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_info
    ADD CONSTRAINT dcs_passenger_info_pkey PRIMARY KEY (dcs_passenger_info_id);


--
-- Name: dcs_passenger_info_request_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_info_request
    ADD CONSTRAINT dcs_passenger_info_request_pkey PRIMARY KEY (dcs_passenger_info_request_id);


--
-- Name: dcs_passenger_info_requested_by_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_info_requested_by_ref
    ADD CONSTRAINT dcs_passenger_info_requested_by_ref_pkey PRIMARY KEY (dcs_passenger_info_requested_by_rcd);


--
-- Name: dcs_passenger_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger
    ADD CONSTRAINT dcs_passenger_pkey PRIMARY KEY (dcs_passenger_id);


--
-- Name: dcs_passenger_request_itinerary_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_request_itinerary_mapping
    ADD CONSTRAINT dcs_passenger_request_itinerary_mapping_pkey PRIMARY KEY (dcs_passenger_request_itinerary_mapping_id);


--
-- Name: dcs_passenger_request_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_request
    ADD CONSTRAINT dcs_passenger_request_pkey PRIMARY KEY (dcs_passenger_request_id);


--
-- Name: dcs_passenger_title_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_title_ref
    ADD CONSTRAINT dcs_passenger_title_ref_pkey PRIMARY KEY (dcs_passenger_title_rcd);


--
-- Name: dcs_passenger_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_type_ref
    ADD CONSTRAINT dcs_passenger_type_ref_pkey PRIMARY KEY (dcs_passenger_type_rcd);


--
-- Name: dcs_passenger_zone_flight_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_zone_flight_mapping
    ADD CONSTRAINT dcs_passenger_zone_flight_mapping_pkey PRIMARY KEY (dcs_passenger_zone_flight_mapping_id);


--
-- Name: dcs_passenger_zone_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_zone_mapping
    ADD CONSTRAINT dcs_passenger_zone_mapping_pkey PRIMARY KEY (dcs_passenger_zone_mapping_id);


--
-- Name: dcs_passenger_zone_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_zone
    ADD CONSTRAINT dcs_passenger_zone_pkey PRIMARY KEY (dcs_passenger_zone_id);


--
-- Name: dcs_passenger_zone_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_passenger_zone_type_ref
    ADD CONSTRAINT dcs_passenger_zone_type_ref_pkey PRIMARY KEY (dcs_passenger_zone_type_rcd);


--
-- Name: dcs_payment_card_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_card
    ADD CONSTRAINT dcs_payment_card_pkey PRIMARY KEY (dcs_payment_creditcard_id);


--
-- Name: dcs_payment_card_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_card_ref
    ADD CONSTRAINT dcs_payment_card_ref_pkey PRIMARY KEY (dcs_payment_card_rcd);


--
-- Name: dcs_payment_cash_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_cash
    ADD CONSTRAINT dcs_payment_cash_pkey PRIMARY KEY (dcs_payment_cash_id);


--
-- Name: dcs_payment_cheque_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_cheque
    ADD CONSTRAINT dcs_payment_cheque_pkey PRIMARY KEY (dcs_payment_cheque_id);


--
-- Name: dcs_payment_cheque_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_cheque_type_ref
    ADD CONSTRAINT dcs_payment_cheque_type_ref_pkey PRIMARY KEY (dcs_payment_cheque_type_rcd);


--
-- Name: dcs_payment_employee_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_employee
    ADD CONSTRAINT dcs_payment_employee_pkey PRIMARY KEY (dcs_payment_employee_id);


--
-- Name: dcs_payment_method_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_method_ref
    ADD CONSTRAINT dcs_payment_method_ref_pkey PRIMARY KEY (dcs_payment_method_rcd);


--
-- Name: dcs_payment_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment
    ADD CONSTRAINT dcs_payment_pkey PRIMARY KEY (dcs_payment_id);


--
-- Name: dcs_payment_refund_charge_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_refund_charge_mapping
    ADD CONSTRAINT dcs_payment_refund_charge_mapping_pkey PRIMARY KEY (dcs_payment_refund_charge_mapping_id);


--
-- Name: dcs_payment_refund_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_refund
    ADD CONSTRAINT dcs_payment_refund_pkey PRIMARY KEY (dcs_payment_refund_id);


--
-- Name: dcs_payment_refund_reason_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_refund_reason_ref
    ADD CONSTRAINT dcs_payment_refund_reason_ref_pkey PRIMARY KEY (dcs_payment_refund_reason_rcd);


--
-- Name: dcs_payment_voucher_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_payment_voucher
    ADD CONSTRAINT dcs_payment_voucher_pkey PRIMARY KEY (dcs_payment_voucher_id);


--
-- Name: dcs_print_identification_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_print_identification
    ADD CONSTRAINT dcs_print_identification_pkey PRIMARY KEY (dcs_print_identification_id);


--
-- Name: dcs_priority_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_priority_ref
    ADD CONSTRAINT dcs_priority_ref_pkey PRIMARY KEY (dcs_priority_rcd);


--
-- Name: dcs_queue_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_queue
    ADD CONSTRAINT dcs_queue_pkey PRIMARY KEY (dcs_queue_id);


--
-- Name: dcs_queue_rule_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_queue_rule
    ADD CONSTRAINT dcs_queue_rule_pkey PRIMARY KEY (dcs_queue_rule_id);


--
-- Name: dcs_queue_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_queue_type_ref
    ADD CONSTRAINT dcs_queue_type_ref_pkey PRIMARY KEY (dcs_queue_type_rcd);


--
-- Name: dcs_queued_flight_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_queued_flight_mapping
    ADD CONSTRAINT dcs_queued_flight_mapping_pkey PRIMARY KEY (dcs_queued_flight_mapping_id);


--
-- Name: dcs_reference_tables_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_reference_tables_ref
    ADD CONSTRAINT dcs_reference_tables_ref_pkey PRIMARY KEY (dcs_reference_tables_rcd);


--
-- Name: dcs_requires_action_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_requires_action_type_ref
    ADD CONSTRAINT dcs_requires_action_type_ref_pkey PRIMARY KEY (dcs_requires_action_type_rcd);


--
-- Name: dcs_search_criteria_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_search_criteria_ref
    ADD CONSTRAINT dcs_search_criteria_ref_pkey PRIMARY KEY (dcs_search_criteria_rcd);


--
-- Name: dcs_seat_attribute_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_seat_attribute_ref
    ADD CONSTRAINT dcs_seat_attribute_ref_pkey PRIMARY KEY (dcs_seat_attribute_rcd);


--
-- Name: dcs_seat_attribute_rule_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_seat_attribute_rule
    ADD CONSTRAINT dcs_seat_attribute_rule_pkey PRIMARY KEY (dcs_seat_attribute_rule_id);


--
-- Name: dcs_seat_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_seat
    ADD CONSTRAINT dcs_seat_pkey PRIMARY KEY (dcs_seat_id);


--
-- Name: dcs_seat_request_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_seat_request_ref
    ADD CONSTRAINT dcs_seat_request_ref_pkey PRIMARY KEY (dcs_seat_request_rcd);


--
-- Name: dcs_selectee_agent_reason_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_selectee_agent_reason_code_ref
    ADD CONSTRAINT dcs_selectee_agent_reason_code_ref_pkey PRIMARY KEY (dcs_selectee_agent_reason_code_rcd);


--
-- Name: dcs_selectee_clearing_reason_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_selectee_clearing_reason_code_ref
    ADD CONSTRAINT dcs_selectee_clearing_reason_code_ref_pkey PRIMARY KEY (dcs_selectee_clearing_reason_code_rcd);


--
-- Name: dcs_selectee_location_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_selectee_location_code_ref
    ADD CONSTRAINT dcs_selectee_location_code_ref_pkey PRIMARY KEY (dcs_selectee_location_code_rcd);


--
-- Name: dcs_selectee_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_selectee
    ADD CONSTRAINT dcs_selectee_pkey PRIMARY KEY (dcs_selectee_id);


--
-- Name: dcs_serial_number_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_serial_number
    ADD CONSTRAINT dcs_serial_number_pkey PRIMARY KEY (dcs_serial_number_id);


--
-- Name: dcs_serial_number_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_serial_number_ref
    ADD CONSTRAINT dcs_serial_number_ref_pkey PRIMARY KEY (dcs_serial_number_rcd);


--
-- Name: dcs_service_request_grouping_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_service_request_grouping_ref
    ADD CONSTRAINT dcs_service_request_grouping_ref_pkey PRIMARY KEY (dcs_service_request_grouping_rcd);


--
-- Name: dcs_service_request_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_service_request_ref
    ADD CONSTRAINT dcs_service_request_ref_pkey PRIMARY KEY (dcs_service_request_rid);


--
-- Name: dcs_setting_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_setting
    ADD CONSTRAINT dcs_setting_pkey PRIMARY KEY (dcs_setting_code);


--
-- Name: dcs_sfpd_action_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_sfpd_action
    ADD CONSTRAINT dcs_sfpd_action_pkey PRIMARY KEY (dcs_sfpd_action_id);


--
-- Name: dcs_unaccompanied_minor_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_unaccompanied_minor
    ADD CONSTRAINT dcs_unaccompanied_minor_pkey PRIMARY KEY (dcs_unaccompanied_minor_id);


--
-- Name: dcs_unseated_passenger_type_escort_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_unseated_passenger_type_escort_mapping
    ADD CONSTRAINT dcs_unseated_passenger_type_escort_mapping_pkey PRIMARY KEY (dcs_unseated_passenger_type_escort_mapping_id);


--
-- Name: dcs_unseated_passenger_type_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_unseated_passenger_type_mapping
    ADD CONSTRAINT dcs_unseated_passenger_type_mapping_pkey PRIMARY KEY (dcs_unseated_passenger_type_mapping_id);


--
-- Name: dcs_upgrade_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_upgrade
    ADD CONSTRAINT dcs_upgrade_pkey PRIMARY KEY (dcs_upgrade_id);


--
-- Name: dcs_upgrade_rule_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_upgrade_rule
    ADD CONSTRAINT dcs_upgrade_rule_pkey PRIMARY KEY (dcs_upgrade_rule_id);


--
-- Name: dcs_user_location_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_user_location_mapping
    ADD CONSTRAINT dcs_user_location_mapping_pkey PRIMARY KEY (dcs_user_location_mapping_id);


--
-- Name: dcs_user_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_user
    ADD CONSTRAINT dcs_user_pkey PRIMARY KEY (dcs_user_id);


--
-- Name: dcs_user_setting_code_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_user_setting_code_ref
    ADD CONSTRAINT dcs_user_setting_code_ref_pkey PRIMARY KEY (dcs_user_setting_code_rcd);


--
-- Name: dcs_user_setting_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_user_setting
    ADD CONSTRAINT dcs_user_setting_pkey PRIMARY KEY (dcs_user_setting_id);


--
-- Name: dcs_user_setting_window_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_user_setting_window
    ADD CONSTRAINT dcs_user_setting_window_pkey PRIMARY KEY (dcs_user_setting_window_id);


--
-- Name: dcs_volunteer_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_volunteer
    ADD CONSTRAINT dcs_volunteer_pkey PRIMARY KEY (dcs_volunteer_id);


--
-- Name: dcs_waive_reason_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_waive_reason_ref
    ADD CONSTRAINT dcs_waive_reason_ref_pkey PRIMARY KEY (dcs_waive_reason_rcd);


--
-- Name: dcs_weight_conversion_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_weight_conversion
    ADD CONSTRAINT dcs_weight_conversion_pkey PRIMARY KEY (dcs_weight_conversion_id);


--
-- Name: dcs_weight_type_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dcs_weight_type_ref
    ADD CONSTRAINT dcs_weight_type_ref_pkey PRIMARY KEY (dcs_weight_type_rcd);


--
-- Name: dd_sample_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dd_sample
    ADD CONSTRAINT dd_sample_pkey PRIMARY KEY (c1);
...
--
-- Name: load_dcs_clear_list_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY load_dcs_clear_list
    ADD CONSTRAINT load_dcs_clear_list_pkey PRIMARY KEY (dcs_clear_list_id);
...
--
-- Name: payments_dcs_ref_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY payments_dcs_ref
    ADD CONSTRAINT payments_dcs_ref_pkey PRIMARY KEY (dcs_payment_id, payment_no);
