...
CREATE TABLE book_commission (
    ...
    comm_amount bigint NOT NULL,
    commission_descr character varying(80),
    commission_sent bigint,
    update_user character(5) NOT NULL,
    update_group character(8) NOT NULL,
    update_time timestamp WITH time zone
);
...
CREATE TABLE book_fares_paym (
    ...
    fare_paymt_amount bigint NOT NULL,
    paid_curr_code character(3) NOT NULL,
...
CREATE TABLE book_paymt_pass (
    ...
    book_paymt_amount bigint NOT NULL,
...
CREATE TABLE commission_volum (
    ...
    valid_from_date date NOT NULL,
    comm_range_from bigint NOT NULL,
    valid_to_date date NOT NULL,
    comm_range_to bigint NOT NULL,
    commission_meth character(1) NOT NULL,
    commission_value bigint NOT NULL,
    active_flag character(1) DEFAULT 'A'::bpchar,
    inactive_date_time timestamp WITH time zone,
...
CREATE TABLE fee (
    ...
    min_fee_value bigint,
    max_fee_value bigint,
...
CREATE TABLE floating_definition (
    ...
    oneway_low_limit_amount bigint NOT NULL,
    return_low_limit_amount bigint NOT NULL,
    oneway_upgrade_amount bigint NOT NULL,
    return_upgrade_amount bigint NOT NULL,
    oneway_premium_amount bigint NOT NULL,
    return_premium_amount bigint NOT NULL,
...
CREATE TABLE tax_category (
    ...
    valid_from_date date NOT NULL,
    valid_to_date date NOT NULL,
    oneway_cap_value bigint NOT NULL,
    return_cap_value bigint NOT NULL,
