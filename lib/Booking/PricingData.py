...
class FarePricingData(object):
    ...
    def apply_taxes(self, aTaxes):
        ...
        for tax in aTaxes:
            if tax.tax_type == '=':
                logger.debug("Add %f to base fare" % tax.tax_amount)
                self.total_amount += tax.tax_amount
            elif tax.tax_type == '%':
                logger.debug("Add %.0f%% to base fare" % tax.tax_amount)
...
class PricingData(object):
    ...
    def __init__(self,
        ...
        logger.debug("New pricing amount %.2f" % (self.total_amount))
...
class PassengerCode(object):
    ...
    def __init__(self,
        ...
        logger.debug("New passenger code %s count %d value %.2f"
...
class FareCode(object):
    ...
    def __init__(self, company_code, fare_basis_code, class_code, passenger_code,
        ...
        logger.debug("New fare code %s class %s ID %s"
...
class FlightCode(object):
    ...
    def __init__(self, flight_no, flight_date, airport_codes):
        ...
        logger.debug("New flight code %s date %s "
